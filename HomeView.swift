...
struct HomeView: View {
    ...
    func endShower() {
        ...
        alertMessage += " You won \(UserStats.totalTimesWon) times so far, consumed an avaerage of \(UserStats.averageLitersConsumed) L, and saved \(UserStats.totalLitersSaved) L.";
